...
#define INPUT_CAPTURE_ID            3
#define UART_ISR_TIMER_ID			4
#define UART_TIMER_ID				5
#define I2C_TIMER_ID		   		6
#define SPI_TIMER_ID				7
#define NRF_SEND_ID                 8
#define CHNL_ID                 	9

//#define GET_ALL_FRAME_TIMER_ID	 9
//#define FIND_KEYWORD_ID         	8

/* using with Special Timer to able  SPI Function to be unstuck */
#define ATMODE_TIMEOUT  			100/SYSTEMTICKTIME
#define SPI_TIMEOUT  				100/SYSTEMTICKTIME
#define UART_WAIT_TIME				1000/SYSTEMTICKTIME
#define GET_ALL_FRAME_TIMEOUT       2000/SYSTEMTICKTIME
#define I2C_WAIT_TIME               100/SYSTEMTICKTIME
/**************************************************
 * configuration types
 *************************************************/
